...
function(input, output, session) {
  ...
  output$hist <- shiny::renderUI({
    ...
    if (input$plotEngine_1 == "base") {
      ...
      plotlyOutput("hist_plotly", width = "70vh", height = "70vh")
    }
  })
  ...
  shiny::observe({
      ...
      if (input$data == "Model parameters (from Parameter simulations)") {
        ...
        lapply(1:(numcols), function(i) {
          list(shiny::textInput(paste0("intervention_",i),
                                label = NULL, #h5(strong("4. Interventions labels"))
    ...
    output$cep <- shiny::renderUI({
      ...
      if (input$plotEngine_2 %in% c("base", "ggplot2")) {
        ...
        plotlyOutput("cepplotly", width = "70vh", height = "70vh")
      }
    })
    ...
    output$eib <- shiny::renderUI({ 
      ...
      if (input$plotEngine_2 == "plotly") {
        plotlyOutput("eibplotly", width = "70vh", height = "70vh")
      } else {
        plotOutput("eibbase")
      }
    })
    ...
    output$ceef <- shiny::renderUI({
      ...
      shiny::req(inputs(),m())
      if (input$plotEngine_2 == "plotly") {
        plotlyOutput("ceefplotly", width = "70vh", height = "70vh")
      } else {
        plotOutput("ceefbase")
      }
    })
    ...
    output$ceac <- shiny::renderUI({
      ...
      if (input$plotEngine_3.1 == "plotly") {
        plotlyOutput("ceacplotly", width = "70vh", height = "70vh")
      } else {
        plotOutput("ceacbase")
      }
    })
    ...
    output$multi_ceac <- shiny::renderUI({
      ...
      if (input$plotEngine_3.2 == "plotly") {
        plotlyOutput("multi_ceacplotly", width = "70vh", height = "70vh")
      } else {
    ...
    output$ceaf <- shiny::renderUI({
      ...
      if (input$plotEngine_3.3 == "plotly") {
        plotlyOutput("ceafplotly", width = "70vh", height = "70vh")
      } else {
        plotOutput("ceafbase")
      }
    })
