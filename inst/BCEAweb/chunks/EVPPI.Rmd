...
method <- ifelse(
  all(compute_evppi()$method=="INLA"),
  "INLA/SPDE",
  ifelse(all(compute_evppi()$method == "GAM"),
         "GAM regression",
...
cat("\n\n")
BCEA::diag.evppi(evppi = compute_evppi(), he = m(), plot_type = "residuals")
```

```{r, echo=FALSE, fig.width=5.5, fig.height=4, fig.align=align}
BCEA::diag.evppi(evppi = compute_evppi(), he = m(), plot_type = "qqplot")
```
